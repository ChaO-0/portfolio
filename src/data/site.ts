...
export const projects = [
  ...
  },
  {
    ...
    title: "Stencil",
    body: "Management software for tattoo studios. Artist calendars, client bookings, deposits and consent paperwork in one place, built around how a studio actually runs its day.",
  ...
  },
  {
    ...
    meta: "EDUCATION · 2026",
    title: "Classportal",
    body: "Tutor and student management for a tutoring business. Scheduling, attendance, progress notes and invoicing, replacing a spreadsheet stack that had stopped scaling.",
